...
static void Render(GLFWwindow* window)
{
    ...
    modelMatrix= glm::scale(modelMatrix,glm::vec3(0.5,0.5,0.5));//scalling by 2x
    modelMatrix= glm::rotate(modelMatrix, -rotationAngle, glm::vec3(1,1,0));//rotating in clockwise direction
...
void MainApplication()
{
    ...
    MainWindow = glfwCreateWindow((int)SCREEN_SIZE.x, (int)SCREEN_SIZE.y,"OBJLoader",NULL,NULL);
    if(!MainWindow)
